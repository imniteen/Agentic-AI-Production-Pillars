...
BASE_DIR_4 = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "4-guardrails"))
sys.path.insert(0, BASE_DIR_4)  # put 4 *before* 3
...
if __name__ == "__main__":
    #index_documents()
    result = asyncio.run(chat_endpoint(ChatRequest(
        user_id="demo-user",
        message="How is the weather in Pune?",
